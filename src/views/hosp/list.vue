    ...
    >
      ...
      <el-table-column label="操作" width="230" align="center">
        <template slot-scope="scope">
          ...
          <router-link style="margin-left:10px;" :to="'/hospSet/hospital/show/'+scope.row.id">
            <el-button type="primary" size="mini">查看</el-button>
          </router-link>
          <router-link style="margin-left:10px;" :to="'/hospSet/hospital/schedule/'+scope.row.hoscode">
...
export default {
  ...
  methods: {
    ...
    provinceChanged() {
      ...
      console.log('valueData: ' + this.value)
    },
